        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    fontSharedMaterial_prop.objectReferenceValue = fontAsset.material;
                }

                fontSharedMaterial_prop.objectReferenceValue = (Material)EditorGUILayout.ObjectField("Material", fontSharedMaterial_prop.objectReferenceValue, typeof(Material), true);
