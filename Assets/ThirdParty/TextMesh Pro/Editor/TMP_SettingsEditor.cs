...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SettingsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(prop_DefaultFontAssetPath, new GUIContent("Path:        FontAssets/"));
            ...
            EditorGUILayout.PropertyField(prop_SpriteAssetPath, new GUIContent("Path:        FontAssets/"));
            EditorGUILayout.EndVertical();
