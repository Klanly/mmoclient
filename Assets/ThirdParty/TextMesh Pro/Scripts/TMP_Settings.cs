    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        public static TMP_Settings instance
        {
            get
            {
                ...
                {
                    TMP_Settings.s_Instance = ObjectPoolManager.GetSharedResource("TMP Settings", EResType.eResFontAsset) as TMP_Settings;
                }
        ...
        public static TMP_Settings LoadDefaultSettings()
        {
            if (s_Instance == null)
            {
                ...
                TMP_Settings settings = ObjectPoolManager.GetSharedResource("TMP Settings", EResType.eResFontAsset) as TMP_Settings;
                if (settings != null)
                    s_Instance = settings;
            }
