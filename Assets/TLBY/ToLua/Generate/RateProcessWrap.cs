...
public class RateProcessWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(RateProcess), typeof(UnityEngine.MonoBehaviour));
		L.RegFunction("SetProcess", SetProcess);
	...
	static int SetProcess(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			RateProcess obj = (RateProcess)ToLua.CheckObject(L, 1, typeof(RateProcess));
