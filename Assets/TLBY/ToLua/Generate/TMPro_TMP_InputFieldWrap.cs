...
public class TMPro_TMP_InputFieldWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("onFocusLost", get_onFocusLost, set_onFocusLost);
	...
	static int get_textViewport(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index textViewport on a nil value" : e.Message);
		}
	}
	...
	static int set_onValueChanged(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			TMPro.TMP_InputField obj = (TMPro.TMP_InputField)o;
			TMPro.TMP_InputField.OnChangeEvent arg0 = (TMPro.TMP_InputField.OnChangeEvent)ToLua.CheckObject(L, 2, typeof(TMPro.TMP_InputField.OnChangeEvent));
	...
	static int set_onValidateInput(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			TMPro.TMP_InputField obj = (TMPro.TMP_InputField)o;
			TMPro.TMP_InputField.OnValidateInput arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (TMPro.TMP_InputField.OnValidateInput)ToLua.CheckObject(L, 2, typeof(TMPro.TMP_InputField.OnValidateInput));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 2);
				arg0 = DelegateFactory.CreateDelegate(typeof(TMPro.TMP_InputField.OnValidateInput), func) as TMPro.TMP_InputField.OnValidateInput;
			}
