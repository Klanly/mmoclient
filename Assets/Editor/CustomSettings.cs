...
public static class CustomSettings
{
    ...
    public static string saveDir = FrameworkPath + "/ToLua/Generate/";
    ...
    {                
        ...
        _GT(typeof(ClickEventListener)),
        _GT(typeof(PressEventListener)),
        _GT(typeof(DragEventListener)),
        _GT(typeof(HoverEventListener)),
        _GT(typeof(LongPressEventListener)),
        ...
        _GT(typeof(ConnectState)),

        _GT(typeof(HeroBehavior)),
        _GT(typeof(PuppetBehavior)),
        _GT(typeof(DummyBehavior)),
        _GT(typeof(ToyBehavior)),
        _GT(typeof(BarrierBehavior)),
        _GT(typeof(ConveyTool)),
        _GT(typeof(EmptyGOBehavior)),
        _GT(typeof(BulletBehavior)),
        _GT(typeof(SummonBehavior)),
        _GT(typeof(NPCBehavior)),
        _GT(typeof(PetBehavior)),
        _GT(typeof(MonsterBehavior)),
        _GT(typeof(DropBehavior)),
        _GT(typeof(TrickBehavior)),
        _GT(typeof(EntityBehaviorMgr)),
        _GT(typeof(LuaModule)),
        _GT(typeof(RateProcess)),
        _GT(typeof(BETween)),
        _GT(typeof(ShowTextUI)),
        _GT(typeof(ShowImgUI)),
        _GT(typeof(RotationModel)),
        _GT(typeof(UIMultiScroller)),
        _GT(typeof(TabControl)),
		_GT(typeof(BETweenMethod)),
		_GT(typeof(BETweenLoop)),
        _GT(typeof(FadeInOutEffect)),
		_GT(typeof(ScrollViewLoop)),
		_GT(typeof(ScrollViewLoopItem)),
        _GT(typeof(DressPart)),
        _GT(typeof(Dress)),
        _GT(typeof(UIFollowingTarget)),
        _GT(typeof(FossilisedEffect)),
    };
