...
public class ResourceManager : Manager
{
    ...
    public static void CreateCharacter(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreateCharacter(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreateCharacter(res, timeToRecycle, 120, func);
    }

    public static void CreateCharacter(string res, LuaFunction func = null)
    {
        CreateCharacter(res, 0, func);
    }

    public static void CreateEffect(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreateEffect(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreateEffect(res, timeToRecycle, 80,func);
    }

    public static void CreateEffect(string res, LuaFunction func = null)
    {
        CreateEffect(res, 0, func);
    }

    public static void CreateUIEffect(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreateUIEffect(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreateUIEffect(res, timeToRecycle,30,func);
    }

    public static void CreateUIEffect(string res, LuaFunction func = null)
    {
        CreateUIEffect(res, 0, func);
    }

    public static void CreateUI(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreateUI(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreateUI(res, timeToRecycle,100, func);
    }

    public static void CreateUI(string res, LuaFunction func = null)
    {
        CreateUI(res, 0, func);
    }

    public static void CreateModel(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreateModel(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreateModel(res, timeToRecycle,100, func);
    }

    public static void CreateModel(string res, LuaFunction func = null)
    {
        CreateModel(res, 0, func);
    }

    public static void CreatePet(string res, float timeToRecycle, float timeToDestroy, LuaFunction func = null)
    {
    ...
    public static void CreatePet(string res, float timeToRecycle, LuaFunction func = null)
    {
        CreatePet(res, timeToRecycle,100,func);
    }

    public static void CreatePet(string res, LuaFunction func = null)
    {
